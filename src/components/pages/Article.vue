<template>
  <div class="content">
      ...
      <div class="cont">
        ...
        <div class="time">
            <p>{{articleData.time | changTimeType}}<span><img src="~@/assets/img/zan.png" alt="" /></span></p>
        </div>
  ...
  methods: {
    getArticleData() {
      this.$http
        ...
        .then(res => {
          // console.log(res);
          this.articleData = res.data[this.articleId];
        })
        .catch(err => {
          console.log(err);
        });
